...
- Relate console output on last step to a previous hack
    - This is similar to the print function in Python where you can check variables to see if it produces the outputs you want

- Explain, how console.log can help find errors in code?
    - `console.log` is a JavaScript method that allows developers to print values and messages to the browser's console. It helps find errors in code by displaying the values of variables and the flow of the program, making it easier to identify unexpected behavior or track the execution of specific code segments.
